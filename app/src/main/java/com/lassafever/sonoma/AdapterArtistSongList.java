...
public class AdapterArtistSongList extends RecyclerView.Adapter<AdapterArtistSongList.ViewHolder> {
    private ArrayList<MediaDataArtistSongList> data;
    private Context context;


    public AdapterArtistSongList(ArrayList<MediaDataArtistSongList> data, Context context){
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        final MediaDataArtistSongList itemList = data.get(i);
        ...
        viewHolder.rowLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i=0; i<data.size(); i++){
                    final MediaDataArtistSongList items = data.get(i);
